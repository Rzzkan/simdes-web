...
<div class="card col-md-12">
    <div class="card-body">
        ...
        <form class="row mt-3" method="POST" action="{{ route('lapak_desa.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-sm-12">
                    <input type="number" name="harga" class="form-control form-control-normal" placeholder="Harga...">
                </div>
            </div>
