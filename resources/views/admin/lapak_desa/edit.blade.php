...
<div class="card col-md-12">
    <div class="card-body">
        ...
        <form class="row mt-3" method="POST" action="{{ route('lapak_desa.update', $data_edit->id) }}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-sm-12">
                    <input value="{{ $data_edit->harga }}" type="number" name="harga" class="form-control form-control-normal" placeholder="Harga...">
                </div>
            </div>
