            ...
            <div class="card-body">
                ...
                <div class="row justify-content-between mb-2">
                    ...
                    <div class="col-md-4 d-flex ">
                        <a href="{{ route('lapak_desa.create') }}" class="ms-auto border-radius-sm btn btn-sm btn-primary px-3"><i class="fas fa-plus" style="margin-right: 6px;"></i> Tambah {{ $subtitle }}</a>
                    </div>
                </div>
                    ...
                    <table id="data_table" class="table table-sm align-items-center px-2 mb-0 text-dark">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>{{ "Rp " . number_format($dt->harga,2,',','.'); }}</strong><br>
                                </td>
                                ...
                                <td class="">
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('lapak_desa.edit', $dt->id) }}">Ubah</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('lapak_desa.destroy', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
