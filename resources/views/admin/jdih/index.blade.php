            ...
            <div class="card-body">
                ...
                <div class="row justify-content-between mb-2">
                    ...
                    <div class="col-md-4 d-flex ">
                        <a href="{{ route('jdih.create') }}" class="ms-auto border-radius-sm btn btn-sm btn-primary px-3"><i class="fas fa-plus" style="margin-right: 6px;"></i> Tambah {{ $subtitle }}</a>
                    </div>
                </div>
                                ...
                                <td class="">
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('jdih.edit', $dt->id) }}">Ubah</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('jdih.destroy', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
