            ...
            <div class="card-body">
                ...
                <div class="row justify-content-between mb-2">
                    ...
                    <div class="col-md-4 d-flex ">
                        <a href="{{ route('apb_desa.create') }}" class="ms-auto border-radius-sm btn btn-sm btn-primary px-3"><i class="fas fa-plus" style="margin-right: 6px;"></i> Tambah {{ $subtitle }}</a>
                    </div>
                </div>
                                ...
                                <td class="">
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('apb_desa.edit', $dt->id) }}">Ubah</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('apb_desa.destroy', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                ...
                                <div class="modal fade modal-lg" id="detail{{ $dt->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal body -->
                                            <div class="modal-body">
                                                <embed type="application/pdf" src="{{ asset($dt->berkas) }}" width="100%" height="800"></embed>
                                            </div>
