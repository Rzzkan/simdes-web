...
<div class="row">
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-12">
                        <div class="numbers">
                            <small style="font-size:12px;" class="mb-0 text-capitalize font-weight-bold text-secondary"><i><u>{{ $dt->status_penduduk }}</u></i></small>
    ...
    <script>
        ...
        <?php foreach ($get_data as $dtg) { ?>
            kategori.push('<?= $dtg->status_penduduk ?>');
