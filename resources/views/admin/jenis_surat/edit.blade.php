...
<div class="card col-md-12">
    <div class="card-body">
        ...
        <form class="row mt-3" method="POST" action="{{ route('jenis_surat.update', $data_edit->id) }}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-sm-12">
                    <input value="{{ $data_edit->nama }}" type="text" name="nama" class="form-control form-control-normal" placeholder="Surat...">
                </div>
            </div>
