...
<div class="card col-md-12">
    <div class="card-body">
        ...
        <form class="row mt-3" method="POST" action="{{ route('jenis_surat.store') }}" enctype="multipart/form-data">
            @csrf

            <div class="form-group col-md-6">
                <label class="col-12">Surat</label>
                <div class="col-sm-12">
                    <input type="text" name="nama" class="form-control form-control-normal" placeholder="Surat...">
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-sm-12">
                    <textarea name="keterangan" class="form-control form-control-normal" placeholder="Keterangan"></textarea>
                </div>
            </div>
