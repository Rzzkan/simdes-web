            ...
            <div class="card-body">
                ...
                <div class="row justify-content-between mb-2">
                    ...
                    <div class="col-md-4 d-flex ">
                        <!-- <a href="{{ route('pengaduan.create') }}" class="ms-auto btn btn-sm btn-primary px-3"><i class="fas fa-plus" style="margin-right: 6px;"></i> Tambah {{ $subtitle }}</a> -->
                    </div>
                </div>
                    ...
                    <table id="data_table" class="table table-sm align-items-center px-2 mb-0 text-dark">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <strong>{{ substr($dt->deskripsi,0,50) . "...." }}</strong><br>
                                ...
                                <td class="">
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('pengaduan.edit', $dt->id) }}">Tindak Lanjut</a>
